...
for j = 1:length(SNR)
    ...
    for i =1:num_samples
        ...
        if mod(i, num_samples2)==1
            ...
            Psi1_values = abs(log((exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(5*pi/4+Phi_h)+1i*sin(5*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(4*pi/4+Phi_h+theta2)+1i*sin(4*pi/4+Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(5*pi/4+Phi_h)+1i*sin(5*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(4*pi/4+Phi_h+theta1)+1i*sin(4*pi/4+Phi_h+theta1))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(2*pi/4+Phi_h+theta2)+1i*sin(2*pi/4+Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(2*pi/4+Phi_h+theta1)+1i*sin(2*pi/4+Phi_h+theta1))))).^2))...
                ./(exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h+theta2)+1i*sin(Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h+theta1)+1i*sin(Phi_h+theta1))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h-theta1)+1i*sin(Phi_h-theta1))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h-theta2)+1i*sin(Phi_h-theta2))))).^2))));
            Psi2_values = abs(log((exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(5*pi/4+Phi_h)+1i*sin(5*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(4*pi/4+Phi_h+theta1)+1i*sin(4*pi/4+Phi_h+theta1))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(2*pi/4+Phi_h+theta2)+1i*sin(2*pi/4+Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                ...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h-theta1)+1i*sin(Phi_h-theta1))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2))...
                ./(exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(5*pi/4+Phi_h)+1i*sin(5*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(4*pi/4+Phi_h+theta2)+1i*sin(4*pi/4+Phi_h+theta2))))).^2)...
                ...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h+theta2)+1i*sin(Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h-theta2)+1i*sin(Phi_h-theta2))))).^2))));
            Psi3_values = abs(log((exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(2*pi/4+Phi_h+theta2)+1i*sin(2*pi/4+Phi_h+theta2))))).^2)...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(2*pi/4+Phi_h+theta1)+1i*sin(2*pi/4+Phi_h+theta1))))).^2)...
                ...
                +exp(-(abs(Y_h-(3*sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(Phi_h-theta2)+1i*sin(Phi_h-theta2))))).^2))));
            Psi4_values = abs(log((exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(5*pi/4+Phi_h)+1i*sin(5*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(3*pi/4+Phi_h)+1i*sin(3*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(1*pi/4+Phi_h)+1i*sin(1*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(2)*H_h*a.*(cos(7*pi/4+Phi_h)+1i*sin(7*pi/4+Phi_h))))).^2)...
                +exp(-(abs(Y_h-(sqrt(10)*H_h*a.*(cos(4*pi/4+Phi_h+theta1)+1i*sin(4*pi/4+Phi_h+theta1))))).^2)...
        ...
        if q_0 < q_1
            t = abs(log(q_0/q_1));
            val = sum(Psi4_values <= t) / length(Psi4_values);
            sum41 = sum41 + val;
        end
        C41 = C41 + log(1+q_1/q_0);
        y8 = Y8(i);
    ...
    for theta = -2500:0.1:-0.1
        f = @(t) log(1 + exp(theta*t));
        re_int = integral(f, 0, 1); 
        re4 = (log(2)-re_int+theta*tot_jifen4)/log(2);
        if re4 > max_re4
            max_re4 = re4;         
            best_theta4 = theta;   
        end
    end
    Capability4 = (log(2)-C4)/log(2);
    data(j,1) = S;
    data(j,2) = max_re1;
    ...
    data(j,11) = max_re4;
    data(j,12) = best_theta4;
    data(j,13) = Capability4;
    data(j,14) = max_re1+max_re2+max_re3+max_re4;
    data(j,15) = Capability1+Capability2+Capability3+Capability4;
end
